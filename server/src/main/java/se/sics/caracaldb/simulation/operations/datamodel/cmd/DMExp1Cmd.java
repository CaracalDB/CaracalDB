...
import se.sics.caracaldb.simulation.operations.datamodel.validators.GetAllTypesValidator;
...
public class DMExp1Cmd extends DMExpCmd {
    public DMExperiment getExp() {
        ...
        GetAllTypes.Req getAllTypes_req1 = new GetAllTypes.Req(tidFactory.newId(), bidFactory.nextId());
        GetAllTypesValidator getAllTypes_val1 = new GetAllTypesValidator(getAllTypes_req1.id, DMMessage.ResponseCode.SUCCESS, getAllTypes_req1.dbId, new HashMap<String, ByteId>());
        builder.add(getAllTypes_req1, getAllTypes_val1);
