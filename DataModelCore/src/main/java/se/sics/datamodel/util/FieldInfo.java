...
public class FieldInfo {
    ...
    public static enum FieldType {
        ...
        public static FieldType parseString(String type) throws TypeInfo.InconsistencyException {
            if (type != null) {
            ...
            throw new TypeInfo.InconsistencyException("Unknown type - expected type : STRING / INTEGER / LONG / BOOLEAN / FLOAT");
        }
    }
}
